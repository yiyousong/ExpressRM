...
parser.add_argument('--model_path', type=str, default=None, help='Path to continue training from, otherwise start fresh.')
parser.add_argument('--seq', type=bool, default=True, help='Use sequence data for training (True or False)')
parser.add_argument('--gene', type=bool, default=False, help='Use gene expression data for training (True or False)')
parser.add_argument('--genelocexp', type=bool, default=False, help='Use gene location expression data for training (True or False)')
parser.add_argument('--geo', type=bool, default=False, help='Use geo data for training (True or False)')
parser.add_argument('--tgeo', type=bool, default=False, help='Use tissue geo data for training (True or False)')
parser.add_argument('--featurelist', type=str, default=None, help='Comma separated list of features to use: sequence, gene, genelocexp, geo, tgeo')
parser.add_argument('--radius', type=int, default=1000, help='Radius for the geo feature (2*radius+1)')
parser.add_argument('--epoch', type=int, default=0, help='Number of epochs to train for.')
parser.add_argument('--prefix', type=str, default='', help='Prefix for the model and results.')
parser.add_argument('--autoprefix', type=bool, default=True, help='Automatically generate prefix based on features (True or False)')
parser.add_argument('--trainlist', type=str, default=None, help='List of training indices, or use the default.')
parser.add_argument('--testlist', type=str, default=None, help='List of test indices (during training), or leave-one-out testing.')
parser.add_argument('--precision', type=int, default=32, help='Precision of calculations (e.g., 16, 32, etc.)')
